const STRINGS = {
  ko: {
    ...
    generalSettings: '일반', filesAndExport: '파일 및 내보내기', annotations: '주석', settingsManagement: '설정 관리',
    language: '언어', theme: '테마', system: '시스템', light: '라이트', dark: '다크',
    imageImport: '이미지 가져오기', imageImportOrientation: '이미지 가져오기 방향', keepOrientation: '이미지 방향 유지', portraitPage: '세로 페이지', landscapePage: '가로 페이지',
    exportDpi: '이미지 내보내기 해상도', imageExportResolution: '이미지 내보내기 해상도', exportDpiHelp: '선택 페이지를 PNG/JPG로 내보낼 때만 적용됩니다. PDF 저장 품질에는 영향을 주지 않습니다.',
    highlightSetting: '형광펜 동작', preferTextLayer: '텍스트에 맞춰 형광펜 표시', highlightHelp: '텍스트가 있는 PDF에서는 글자 줄에 맞춰 표시합니다. 텍스트가 없는 스캔 PDF에서는 드래그한 영역을 그대로 사용합니다.',
    pdfSecurity: 'PDF 보안', outputPassword: '저장할 PDF 암호', noPassword: '암호 없음',
    outputPasswordHelp: '편집한 PDF를 저장할 때 적용됩니다. 암호화하지 않으려면 비워 두세요.',
    annotationDefaults: '기본 스타일', color: '색상', opacity: '불투명도', lineWidth: '선 두께', textSize: '텍스트 크기',
    exportSettings: '설정 내보내기', importSettings: '설정 가져오기', settingsManagementHelp: '내보내기는 현재 저장된 설정을 JSON 파일로 저장합니다. 가져오기는 선택한 설정을 즉시 적용합니다.', cancel: '취소', saveButton: '저장',
  ...
  en: {
    ...
    generalSettings: 'General', filesAndExport: 'Files & export', annotations: 'Annotations', settingsManagement: 'Settings management', language: 'Language', theme: 'Theme', system: 'System', light: 'Light', dark: 'Dark', imageImport: 'Image import', imageImportOrientation: 'Image import orientation', keepOrientation: 'Keep image orientation', portraitPage: 'Portrait page', landscapePage: 'Landscape page', exportDpi: 'Image export resolution', imageExportResolution: 'Image export resolution', exportDpiHelp: 'Only affects PNG/JPG page export. It does not change PDF save quality.', highlightSetting: 'Highlight behavior', preferTextLayer: 'Align highlights to text', highlightHelp: 'On PDFs with text, highlights follow the text lines. On scanned PDFs without text, the dragged area is used as-is.', pdfSecurity: 'PDF security', outputPassword: 'Saved PDF password', noPassword: 'No password', outputPasswordHelp: 'Applied when the edited PDF is saved. Leave blank for an unencrypted output.', annotationDefaults: 'Default style', color: 'Color', opacity: 'Opacity', lineWidth: 'Line width', textSize: 'Text size', exportSettings: 'Export settings', importSettings: 'Import settings', settingsManagementHelp: 'Export saves the currently stored settings as JSON. Import applies the selected settings immediately.', cancel: 'Cancel', saveButton: 'Save', settingsImported: 'Settings imported.',
  ...
  ja: {
    ...
    generalSettings: '一般', filesAndExport: 'ファイルと書き出し', annotations: '注釈', settingsManagement: '設定の管理', language: '言語', theme: 'テーマ', system: 'システム', light: 'ライト', dark: 'ダーク', imageImport: '画像の読み込み', imageImportOrientation: '画像読み込み時の向き', keepOrientation: '画像の向きを維持', portraitPage: '縦向きページ', landscapePage: '横向きページ', exportDpi: '画像書き出し解像度', imageExportResolution: '画像書き出し解像度', exportDpiHelp: '選択ページをPNG/JPGで書き出す場合にのみ適用されます。PDF保存の品質には影響しません。', highlightSetting: 'ハイライトの動作', preferTextLayer: 'テキストに合わせてハイライト', highlightHelp: 'テキストを含むPDFでは文字の行に合わせて表示します。テキストのないスキャンPDFではドラッグ範囲をそのまま使用します。', pdfSecurity: 'PDFセキュリティ', outputPassword: '保存するPDFのパスワード', noPassword: 'パスワードなし', outputPasswordHelp: '編集したPDFの保存時に適用されます。暗号化しない場合は空欄にしてください。', annotationDefaults: '既定のスタイル', color: '色', opacity: '不透明度', lineWidth: '線の太さ', textSize: '文字サイズ', exportSettings: '設定を書き出す', importSettings: '設定を読み込む', settingsManagementHelp: '書き出しは現在保存されている設定をJSONで保存します。読み込みは選択した設定をすぐに適用します。', cancel: 'キャンセル', saveButton: '保存', settingsImported: '設定を読み込みました。',
  ...
  es: {
    ...
    generalSettings: 'General', filesAndExport: 'Archivos y exportación', annotations: 'Anotaciones', settingsManagement: 'Gestión de ajustes', language: 'Idioma', theme: 'Tema', system: 'Sistema', light: 'Claro', dark: 'Oscuro', imageImport: 'Importar imagen', imageImportOrientation: 'Orientación al importar imágenes', keepOrientation: 'Mantener orientación de la imagen', portraitPage: 'Página vertical', landscapePage: 'Página horizontal', exportDpi: 'Resolución de exportación de imagen', imageExportResolution: 'Resolución de exportación de imagen', exportDpiHelp: 'Solo afecta a la exportación de páginas como PNG/JPG. No cambia la calidad al guardar el PDF.', highlightSetting: 'Comportamiento del resaltado', preferTextLayer: 'Ajustar el resaltado al texto', highlightHelp: 'En PDF con texto, el resaltado sigue las líneas de texto. En PDF escaneados sin texto, se usa directamente el área arrastrada.', pdfSecurity: 'Seguridad PDF', outputPassword: 'Contraseña del PDF guardado', noPassword: 'Sin contraseña', outputPasswordHelp: 'Se aplica al guardar el PDF editado. Déjalo vacío para guardar sin cifrado.', annotationDefaults: 'Estilo predeterminado', color: 'Color', opacity: 'Opacidad', lineWidth: 'Grosor de línea', textSize: 'Tamaño de texto', exportSettings: 'Exportar ajustes', importSettings: 'Importar ajustes', settingsManagementHelp: 'Exportar guarda los ajustes almacenados actualmente como JSON. Importar aplica inmediatamente los ajustes seleccionados.', cancel: 'Cancelar', saveButton: 'Guardar', settingsImported: 'Ajustes importados.',
